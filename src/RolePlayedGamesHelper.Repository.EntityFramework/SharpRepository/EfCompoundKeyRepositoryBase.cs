...
namespace RolePlayedGamesHelper.Repository.EntityFramework.SharpRepository
{
    ...
    public class EfCompoundKeyRepositoryBase<T, TKey, TKey2> : LinqCompoundKeyRepositoryBase<T, TKey, TKey2> where T : class
    {
        ...
        internal EfCompoundKeyRepositoryBase(IEfDbContext dbContext, ICompoundKeyCachingStrategy<T, TKey, TKey2> cachingStrategy = null)
            : base(cachingStrategy)
        {
            Initialize(dbContext);
        }

        private void Initialize(IEfDbContext dbContext)
        {
            Context = dbContext;
            DbSet = Context.Set<T>();
        }
    ...
    public class EfCompoundKeyRepositoryBase<T, TKey, TKey2, TKey3> : LinqCompoundKeyRepositoryBase<T, TKey, TKey2, TKey3> where T : class
    {
        ...
        internal EfCompoundKeyRepositoryBase(IEfDbContext dbContext, ICompoundKeyCachingStrategy<T, TKey, TKey2, TKey3> cachingStrategy = null)
            : base(cachingStrategy)
        {
            Initialize(dbContext);
        }
